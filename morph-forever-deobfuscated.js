...
var playerTransformation = Boot.prototype.game['_state']['_current'].user.source.data.playerTransformation;

if (!playerTransformation) {
  alert('You must have a morph enabled to use this hack.');
} else {
  playerTransformation.maxTime = Infinity;
  playerTransformation.timeRemaining = Infinity;
}
